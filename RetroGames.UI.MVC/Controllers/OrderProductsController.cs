...
namespace RetroGames.UI.MVC.Controllers
{
    public class OrderProductsController : Controller
    {
        ...
        public OrderProductsController(RetroGamesContext context)
        {
            _context = context;
        }
        ...
        {
            var retroGamesContext = _context.OrderProducts.Include(o => o.Order).Include(o => o.Product);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'RetroGamesContext.OrderProducts'  is null.");
            }
            var orderProduct = await _context.OrderProducts.FindAsync(id);
            if (orderProduct != null)
            {
