...
namespace RetroGames.UI.MVC.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(RetroGamesContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ProductId,ProductName,ProductPrice,ReleaseDate,ProductDescription,UnitsInStock,ConsoleTypeId,ManufacturerId,CategoryId,GenreId,IsDiscontinued,ProductImage")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductId,ProductName,ProductPrice,ReleaseDate,ProductDescription,UnitsInStock,ConsoleTypeId,ManufacturerId,CategoryId,GenreId,IsDiscontinued,ProductImage")] Product product)
        {
